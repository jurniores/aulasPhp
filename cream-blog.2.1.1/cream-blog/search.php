 ...
 */
	...
	<div class="cb-container">
	    <div class="cb-mid-wrap cb-innerpage-mid-wrap cb-search-page-wrap <?php if( !empty( $sidebar_existence ) ) { echo esc_attr( $sidebar_existence ); } ?>">
	        <?php
	        /**
	                ...
	                <div id="primary" class="content-area">
	                    <main id="main" class="site-main">
	                    	...
	                    	if( have_posts() ) {
		                        ...
		                        </section><!-- cb-page-entry.search-page-entry -->
		                        <?php
		                    } else {
	    ...
	    </div><!-- .cb-mid-wrap.cb-innerpage-mid-wrap.cb-search-page-wrap -->
	</div><!-- .cb-container -->
	<?php
	get_footer();
